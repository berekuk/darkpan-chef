...
cron "cpan-api-index-pinto-authors" do
    command "if [ -e /opt/pinto/darkpan/authors/00whois.xml ]; then flock -n /opt/metacpan.index-authors.lock -c '/opt/cpan-api/bin/metacpan author --cpan /opt/pinto/darkpan >>/opt/log/metacpan-index-authors.log 2>>/opt/log/metacpan-index-authors.err.log'; fi"
end
